		...
		<div className='p-8'>
			...
			{showGroupForm && (
				<form
					...
					className='mb-8 border border-white p-4 bg-gray-100 rounded-lg'>
					<h2 className='text-xl text-white font-bold mb-4'>
						Create New Group
					</h2>
					<input
			...
			<Link href='/clients/all'>
				<p className='inline-block text-blue  font-extrabold py-2 px-4 rounded text-center mb-4 transition duration-300'>
					See all clients
				</p>
			</Link>
