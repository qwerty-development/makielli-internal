...
export default function Home() {
  return (
    <main className="flex min-h-screen bg-gray flex-col items-center justify-center p-24 bg-gray-100">
      <div>
        <Image src="/logo/logo.png" alt="Logo" width={500} height={500} />
      </div>
      <h1 className="text-4xl text-white font-bold mb-8">Welcome to Your Management System</h1>
