...
const SupplierFinancialReportPDF = ({
	supplierName,
	supplierDetails,
	companyDetails,
	financialData
		...
		<Document>
			<Page size='A4' style={styles.page}>
				<View style={styles.header}>
					...
					<Text style={styles.title}>Supplier Financial Report</Text>
				</View>

				<View style={styles.section}>
					<Text style={styles.subtitle}>Supplier Information</Text>
					<View style={styles.infoRow}>
						<Text style={[styles.text, styles.infoLabel]}>Name:</Text>
						<Text style={[styles.text, styles.infoValue]}>{supplierName}</Text>
					</View>
					<View style={styles.infoRow}>
					...
					<View style={styles.infoRow}>
						<Text style={[styles.text, styles.infoLabel]}>Location:</Text>
						<Text style={[styles.text, styles.infoValue]}>
					...
					<View style={styles.infoRow}>
						...
						<Text
							style={[
								...
								{
									color:
										supplierDetails.balance >= 0
											? colors.success
											: colors.danger
								}
							]}>
							${supplierDetails.balance.toFixed(2)}
						</Text>
					</View>
				</View>
				...
				{companyDetails && (
					<View style={styles.section}>
						<Text style={styles.subtitle}>Associated Company Information</Text>
						<View style={styles.infoRow}>
